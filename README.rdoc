...
If you have ever developed an iOS app, you most likely have had to deal with the tedious tasks of manually building, packaging, 
checking in, tagging, and distributing your iOS applications to your testers through testflightapp.com. 
...
This gem is going to make your life much easier. Here is what it does:
...
If you don't like being asked questions and prefer to configure your project manually, just create a .tesflight file yourself and provide the following information:
  ...
  build:
    developer_name:     "My Company Inc"  # This must be your company name or your name as it appears in your .cer from Apple
  ...
  testflight: 
    ...
    distribution_lists: ["Developers", "Testers", "Everyone"] # Configure your distribution lists at https://testflightapp.com
