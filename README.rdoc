...
iOS applications to testflightapp.com. You are probably wondering if there is a better way to do it.
...
Once you have checked in (you only need to it once per project), you are ready for takeoff. Go to your project folder and simple type:
